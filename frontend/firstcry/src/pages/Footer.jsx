      ...
      <Box 
        ...
        <Container as={Stack} maxW={'6xl'} py={10}>
          <SimpleGrid columns={{ base: 1, sm: 2, md: 4 }} spacing={8}>
            ...
            <Stack align={'flex-start'}>
              <ListHeader>FIRSTCRY PARENTING</ListHeader>
              ...
              <Link href={'#'}>Pregnancy</Link>
              <Link href={'#'}>Toddler</Link>
              <Link href={'#'}>Growth Tracker</Link>
              <Link href={'#'}>FirstCry Parenting YouTube</Link>
            </Stack>
            <Stack align={'flex-start'}>
              <ListHeader>SHIPPING & POLICIES</ListHeader>
              ...
              <Link href={'#'}>Responsible Disclouser</Link>
            </Stack>
            <Stack align={'flex-start'}>
              <ListHeader>OUR APPS</ListHeader>
              <Link href={'#'}>Facebook</Link>
              <Link href={'#'}>Twitter</Link>
              <Link href={'#'}>Dribbble</Link>
              <Link href={'#'}>Instagram</Link>
              <Link href={'#'}>LinkedIn</Link>
            <Image src="https://cdn.fcglcdn.com/brainbees/images/intellitots-franchise-footer-banner.webp">
              </Image>
        ...
        <Box py={10}>
          <Flex
            ...
            <Image src='https://cdn.fcglcdn.com/brainbees/images/n/fc_logo.png'></Image>
          </Flex>
          <Text fontWeight={"semibold"}   pt={6} fontSize={"17px"} textAlign={'center'}>
            © 2022-2023 FirstCry.com All rights reserved
          </Text>
          <Text fontWeight={"semibold"}  fontSize={"12px"}>Made by Md Arif Ali</Text>
          <HStack>
